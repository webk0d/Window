...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_5__["default"])('#timer', '2020-06-24');
    ...
    item.addEventListener('submit', function (e) {
      ...
      postData('assets/server.php', formData).then(function (res) {
        ...
        setTimeout(function () {
          ...
          Object(_modal__WEBPACK_IMPORTED_MODULE_5__["closeModal"])();
        }, 5000);
      });
    });
  });
...
var modal = function modal() {
  function bindModal(triggerOpen, triggerClose, modalSelector) {
    var closeClickOverlay = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : true;
    var modalTriggerOpen = document.querySelectorAll(triggerOpen),
        modal = document.querySelector(modalSelector),
        modalTriggerClose = document.querySelectorAll(triggerClose);
    modalTriggerOpen.forEach(function (item) {
    ...
    modalTriggerClose.forEach(function (item) {
...
var timer = function timer(id, deadline) {
  ...
  function setClock(selector, endTime) {
    ...
    function updateClock() {
      var t = getTimeRemanining(endTime);
